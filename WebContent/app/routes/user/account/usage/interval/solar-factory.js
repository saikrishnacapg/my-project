angular.module('myaccount.route').factory('solarChartServer', function ($log, $q, HTML5_DATE_FORMAT, solarService, solarHttpServer) {
	...
	Highcharts.extend(Highcharts.Chart.prototype, {
		emailChart: function (emailOptions, options, chartOptions) {
			...
			var promise = solarHttpServer.sendChartEmail({
	...
	function consumptionChart(singleDayGraph) {
		...
		consumptionChartDetails.chart.renderTo = 'solarconsumptionChart';
